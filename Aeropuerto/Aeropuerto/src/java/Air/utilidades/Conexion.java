...
public class Conexion {
    ...
    {
    try{        
        setCon(DriverManager.getConnection("jdbc:mysql://localhost:3306/aeropuerto jmc","root",""));
    ...
    public static void main(String param[]){
        ...
        try{
            ResultSet r = conecction.getCon().prepareStatement("select * from logueo").executeQuery();
          
            
               while(r.next()){
                    System.out.println("Perfil:  "+r.getInt(1)+" Nombre: "+r.getString(2) + " Clave: " +r.getString(3));
