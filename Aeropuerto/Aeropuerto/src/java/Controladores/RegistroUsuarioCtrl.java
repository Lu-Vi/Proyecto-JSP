...
@WebServlet(name = "RegistroUsuarioCtrl", urlPatterns = {"/RegistroUsuarioCtrl"})
public class RegistroUsuarioCtrl extends HttpServlet {
...
//         Conexion con=new Conexion();
        ...
        if (request.getParameter("botonCancelar")!=null){
            response.sendRedirect("/ProyectoAeropuerto/index.html");
        }
