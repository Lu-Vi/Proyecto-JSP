    ...
    <body>
        ...
        <div class="container">
            ...
            -->
             ...
             <form class="form-inline justify-content-end"  name="inicioForm" action="Controladores/InicioCtrl" method="post">
                <ul class="nav m-3">
                     <li class="nav-item">
            ...
            <h1 align="left"><i>Aeropuerto Internacional Jose María Córdoba</i></h1>
            </font>
            <h2 style="text-align: left">Fallas técnicas</h2>

            <form class="form-inline justify-content-end"  name="registro" action="Controladores/InicioCtrl" method="post">
                <li class="nav-item">

                    <button class="btn btn-primary btn-lg active" name ="btnRegistro" type="submit">Regístrate con nosotros</button>
                </li>
                </ul>
            </form>
            ...
            <ul class="nav nav-pills nav-fill bg-primary nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a id="vision-tab" data-toggle="tab" href="#vision" role="tab" aria-controls="vision" aria-selected="true" style="color: white" class="nav-link">Visión</a>
                </li>
                <li class="nav-item">
                    <a id="mision-tab" data-toggle="tab" href="#mision" role="tab" aria-controls="mision" aria-selected="false" style="color: white" class="nav-link">Misión</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a id="contactenos-tab" data-toggle="tab" href="#contactenos" role="tab" aria-controls="contactenos" aria-selected="false" style="color: white" class="nav-link">Contáctenos</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active m-5" id="vision" role="tabpanel" aria-labelledby="vision-tab">
                    ...
                    <p>Ser una entidad reconocida como líder internacional con una cartera de concesiones para 
                ...
                <div class="tab-pane fade m-5" id="mision" role="tabpanel" aria-labelledby="mision-tab">
                    <div align="center"> <img src="./img/Avion pasajeros logo.jpg" width="20%" height="20%"> </div>
                    <p>El objetivo de la Empresa es la administración, operación, explotación comercial, adecuación, 
                        modernización y mantenimiento de las terminales aéreas Olaya Herrera de Medellín, José 
                        María Córdova de Rionegro, Los Garzones de Montería,  Antonio Roldán Betancur de Carepa, 
                        El Caraño de Quibdó y Las Brujas de Corozal.</p>
                </div>

                <div class="tab-pane fade m-5" id="servicios" role="tabpanel" aria-labelledby="servicios-tab">
                    <div align="center"> <img src="./img/Avion pasajeros logo.jpg" width="20%" height="20%"> </div> 
                    <p>Brindamos ayuda para esclarecer el problema de los múltiples daños y averías que se 
                ...
                <div class="tab-pane fade m-5" id="contactenos" role="tabpanel" aria-labelledby="contactenos-tab">
                    <div align="center"> <img src="./img/Avion pasajeros logo.jpg" width="20%" height="20%"> </div>
                    <center>
                        <p>Llámanos de lunes a viernes de 9:00 a 20:00h. Sábados de 9:00 a 14:00h.</p>
                    </center>
                    <div align='center'>
                        <font color="Navy" font="Courier">
                        <h4 align="center"><i>01-8000-912002. Teléfono 597 83 00, extensiones: 2532 y 2605.</i></h4>
                        </font>
                    </div>
                    <center>
                        <p>O escríbenos, en cualquier horario. Nos daremos el gusto de comunicarnos con usted.</p>
                    </center>
                    <div align='center'>
                        <font color="Navy" font="Courier">
